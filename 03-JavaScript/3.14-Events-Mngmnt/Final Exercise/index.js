...
// - Instala la dependencia HTTP Server en entorno global (https://www.npmjs.com/package/http-server) -> npm i http-server
...
btn.addEventListener("click", () => {
  alert("Click in this button") ? console.log("OK") : console.log("NO");
});
